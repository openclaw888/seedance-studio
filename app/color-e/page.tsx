...
/* ── Monochrome Premium ──
   Rich layered dark grays (3-4 levels), white + small orange-red accent,
   layered white text. Like RED Camera UI.
*/
const theme = {
  "--bg":            "oklch(14% 0.003 65)",
  "--bg-surface":    "oklch(18% 0.003 65)",
  "--bg-elevated":   "oklch(22% 0.003 65)",
  "--bg-invert":     "oklch(93% 0.005 65)",

  "--text":          "oklch(92% 0.003 65)",
  "--text-2":        "oklch(75% 0.003 65)",
  "--text-3":        "oklch(55% 0.003 65)",
  "--text-muted":    "oklch(40% 0.003 65)",

  "--border":        "oklch(24% 0.003 65)",
  "--border-2":      "oklch(30% 0.005 65)",

  "--accent":        "oklch(58% 0.2 25)",
  "--accent-hover":  "oklch(52% 0.22 25)",
  "--accent-light":  "oklch(22% 0.06 25)",
  "--accent-text":   "oklch(14% 0.005 65)",
...
export default function ColorE() {
        ...
        <div style={{ maxWidth: "72rem", margin: "0 auto", padding: "0 var(--space-lg)" }}>
          ...
          >
            {siteConfig.showcase.items.map((item, i) => {
              const grays = [0, 15, 30, 345, 10, 20];
              const hue = grays[i % grays.length];
              return (
                <div
                  key={i}
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = "0 8px 24px oklch(8% 0.003 65 / 0.4)";
                  }}
                  onMouseLeave={(e) => {
                ...
                >
                  ...
                  >
                    ...
                    >
                      <svg width="16" height="16" viewBox="0 0 24 24" fill={`oklch(55% 0.15 25)`}>
              ...
              >
                ...
                <div style={{ marginBottom: "var(--space-xl)" }}>
                  ...
                  <p
                    style={{
                      fontSize: "0.8125rem",
                      color: isFeatured ? "oklch(45% 0.003 65)" : "var(--text-muted)",
                      marginTop: "var(--space-xs)",
                    }}
                  >
                    {tier.description}
                ...
                <button
                  ...
                  style={{
                    ...
                    color: isFeatured ? "oklch(95% 0.003 65)" : "var(--text)",
                    fontSize: "0.875rem",
                    fontWeight: 600,
                    cursor: "pointer",
                  ...
                  {tier.features.map((feature, j) => (
                    <li
                      ...
                      style={{
                        gap: "var(--space-sm)",
                        fontSize: "0.875rem",
                        color: isFeatured ? "oklch(35% 0.003 65)" : "var(--text-2)",
                      }}
                    >
                      <svg
                        width="14"
                        ...
                        viewBox="0 0 24 24"
                        fill="none"
                        stroke={isFeatured ? "oklch(50% 0.18 25)" : "oklch(58% 0.2 25)"}
                        strokeWidth={2.5}

...
/* ── Deep Space ──
   Very dark cool blue-black bg, ice-blue/electric-blue accents,
   cool gray-white text. Space console feel.
*/
const theme = {
  "--bg":            "oklch(12% 0.025 245)",
  "--bg-surface":    "oklch(15% 0.022 245)",
  "--bg-elevated":   "oklch(18% 0.02 245)",
  "--bg-invert":     "oklch(92% 0.015 230)",

  "--text":          "oklch(93% 0.012 230)",
  "--text-2":        "oklch(78% 0.015 230)",
  "--text-3":        "oklch(62% 0.018 235)",
  "--text-muted":    "oklch(48% 0.015 240)",

  "--border":        "oklch(22% 0.02 245)",
  "--border-2":      "oklch(28% 0.025 245)",

  "--accent":        "oklch(62% 0.18 230)",
  "--accent-hover":  "oklch(56% 0.2 230)",
  "--accent-light":  "oklch(25% 0.06 230)",
  "--accent-text":   "oklch(12% 0.02 245)",
...
export default function ColorA() {
        ...
        <div style={{ maxWidth: "72rem", margin: "0 auto", padding: "0 var(--space-lg)" }}>
          ...
          >
            {siteConfig.showcase.items.map((item, i) => {
              const hues = [230, 210, 250, 220, 260, 200];
              ...
              return (
                <div
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = "0 8px 24px oklch(12% 0.03 245 / 0.3)";
                  }}
                  onMouseLeave={(e) => {
                ...
                >
                  ...
                  >
                    ...
                    >
                      <svg width="16" height="16" viewBox="0 0 24 24" fill={`oklch(65% 0.15 ${hue})`}>
              ...
              >
                ...
                <div style={{ marginBottom: "var(--space-xl)" }}>
                  ...
                  <p
                    style={{
                      fontSize: "0.8125rem",
                      color: isFeatured ? "oklch(35% 0.015 230)" : "var(--text-muted)",
                      marginTop: "var(--space-xs)",
                    }}
                  >
                    {tier.description}
                  ...
                  {tier.features.map((feature, j) => (
                    <li
                      ...
                      style={{
                        gap: "var(--space-sm)",
                        fontSize: "0.875rem",
                        color: isFeatured ? "oklch(25% 0.015 230)" : "var(--text-2)",
                      }}
                    >
                      <svg
                        width="14"
                        ...
                        viewBox="0 0 24 24"
                        fill="none"
                        stroke={isFeatured ? "oklch(45% 0.15 230)" : "oklch(62% 0.18 230)"}
                        strokeWidth={2.5}

...
/* ── Obsidian ──
   Deep dark with very subtle purple tint, warm white + amber highlights,
   soft warm-white text. Film post-production tool feel.
*/
const theme = {
  "--bg":            "oklch(14% 0.012 300)",
  "--bg-surface":    "oklch(17% 0.01 300)",
  "--bg-elevated":   "oklch(20% 0.01 300)",
  "--bg-invert":     "oklch(92% 0.015 75)",

  "--text":          "oklch(90% 0.01 75)",
  "--text-2":        "oklch(75% 0.012 75)",
  "--text-3":        "oklch(58% 0.01 300)",
  "--text-muted":    "oklch(44% 0.01 300)",

  "--border":        "oklch(23% 0.01 300)",
  "--border-2":      "oklch(28% 0.015 300)",

  "--accent":        "oklch(72% 0.14 75)",
  "--accent-hover":  "oklch(66% 0.16 75)",
  "--accent-light":  "oklch(25% 0.05 75)",
  "--accent-text":   "oklch(15% 0.015 300)",
              ...
              return (
                <div
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = "0 8px 24px oklch(14% 0.015 300 / 0.3)";
                  }}
                  onMouseLeave={(e) => {
                ...
                >
                  ...
                  >
                    ...
                    >
                      <svg width="16" height="16" viewBox="0 0 24 24" fill={`oklch(72% 0.12 ${hue})`}>
              ...
              >
                ...
                <div style={{ marginBottom: "var(--space-xl)" }}>
                  ...
                  <p
                    style={{
                      fontSize: "0.8125rem",
                      color: isFeatured ? "oklch(40% 0.01 75)" : "var(--text-muted)",
                      marginTop: "var(--space-xs)",
                    }}
                  >
                    {tier.description}
                  ...
                  {tier.features.map((feature, j) => (
                    <li
                      ...
                      style={{
                        gap: "var(--space-sm)",
                        fontSize: "0.875rem",
                        color: isFeatured ? "oklch(30% 0.01 75)" : "var(--text-2)",
                      }}
                    >
                      <svg
                        width="14"
                        ...
                        viewBox="0 0 24 24"
                        fill="none"
                        stroke={isFeatured ? "oklch(50% 0.12 75)" : "oklch(72% 0.14 75)"}
                        strokeWidth={2.5}

...
/* ── Electric Indigo ──
   Near-black deep indigo bg, bright indigo + lavender accents,
   blue-tinted cool white text. Strong tech feel.
*/
const theme = {
  "--bg":            "oklch(11% 0.03 280)",
  "--bg-surface":    "oklch(14% 0.025 280)",
  "--bg-elevated":   "oklch(18% 0.025 280)",
  "--bg-invert":     "oklch(92% 0.02 280)",

  "--text":          "oklch(92% 0.015 270)",
  "--text-2":        "oklch(76% 0.02 275)",
  "--text-3":        "oklch(58% 0.02 280)",
  "--text-muted":    "oklch(42% 0.02 280)",

  "--border":        "oklch(20% 0.025 280)",
  "--border-2":      "oklch(26% 0.03 280)",

  "--accent":        "oklch(58% 0.22 280)",
  "--accent-hover":  "oklch(52% 0.24 280)",
  "--accent-light":  "oklch(25% 0.08 280)",
  "--accent-text":   "oklch(12% 0.025 280)",
...
export default function ColorD() {
      ...
      >
        <div style={{ maxWidth: "52rem" }}>
          ...
          >
            ...
            <br />
            <span style={{ color: "oklch(72% 0.16 290)" }}>{siteConfig.hero.titleAccent}</span>
          </h1>
        ...
        <div style={{ maxWidth: "72rem", margin: "0 auto", padding: "0 var(--space-lg)" }}>
          ...
          >
            {siteConfig.showcase.items.map((item, i) => {
              const hues = [280, 290, 270, 300, 265, 285];
              ...
              return (
                <div
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.boxShadow = "0 8px 24px oklch(11% 0.04 280 / 0.35)";
                  }}
                  onMouseLeave={(e) => {
                ...
                >
                  ...
                  >
                    ...
                    >
                      <svg width="16" height="16" viewBox="0 0 24 24" fill={`oklch(60% 0.2 ${hue})`}>
              ...
              >
                ...
                <div style={{ marginBottom: "var(--space-xl)" }}>
                  ...
                  <p
                    style={{
                      fontSize: "0.8125rem",
                      color: isFeatured ? "oklch(40% 0.015 280)" : "var(--text-muted)",
                      marginTop: "var(--space-xs)",
                    }}
                  >
                    {tier.description}
                  ...
                  {tier.features.map((feature, j) => (
                    <li
                      ...
                      style={{
                        gap: "var(--space-sm)",
                        fontSize: "0.875rem",
                        color: isFeatured ? "oklch(28% 0.015 280)" : "var(--text-2)",
                      }}
                    >
                      <svg
                        width="14"
                        ...
                        viewBox="0 0 24 24"
                        fill="none"
                        stroke={isFeatured ? "oklch(42% 0.18 280)" : "oklch(58% 0.22 280)"}
                        strokeWidth={2.5}
